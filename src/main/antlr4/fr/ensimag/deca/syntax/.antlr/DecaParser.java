// Generated from /home/hiba/ensimag/GL/gl42/src/main/antlr4/fr/ensimag/deca/syntax/DecaParser.g4 by ANTLR 4.13.1
...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		BLOCK_COMMENT=51, WS=52, FINAL=53;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"IDENT", "INCLUDE", "LINE_COMMENT", "BLOCK_COMMENT", "WS", "FINAL"
		};
	}
	...
	public final Class_bodyContext class_body() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 9288674231582720L) != 0)) {
				{
				setState(519);
				_errHandler.sync(this);
