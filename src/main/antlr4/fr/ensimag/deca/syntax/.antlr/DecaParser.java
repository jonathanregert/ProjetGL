...
public class DecaParser extends AbstractDecaParser {
	...
	public static final int
		...
		BLOCK_COMMENT=52, WS=53, LPAREN=54, CPAREN=55;
	public static final int
	...
	public final List_instContext list_inst() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 282574488346528L) != 0)) {
				{
				{
				setState(124);
	...
	public final Assign_exprContext assign_expr() throws RecognitionException {
		...
		try {
			...
			{
			setState(236);
			((Assign_exprContext)_localctx).e = lvalue(0);
			setState(242);
			_errHandler.sync(this);
			switch (_input.LA(1)) {
			case EQUALS:
	...
	public static class Decl_methodContext extends ParserRuleContext {
		...
		public TerminalNode LPAREN() { return getToken(DecaParser.LPAREN, 0); }
		public TerminalNode CPAREN() { return getToken(DecaParser.CPAREN, 0); }
		public TypeContext type() {
			return getRuleContext(TypeContext.class,0);
		}
		public IdentContext ident() {
